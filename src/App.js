...
import './App.css';
import abhiImage from "src/Screenshot-_51_.jpeg"; 
...
function App() {
  ...
  return (
    <div className="App">
      <header>
        <div className="user">
          <img src={abhiImage} alt="MANOJKUMAR" />
          <h3 className="name">MANOJKUMAR</h3>
        </div>
      ...
      <section className="home" id="home">
        <h3>HELLO!!</h3>
        <h1>This is <span>MANOJKUMAR</span></h1>
      </section>
      ...
      <section className="education" id="education">
        ...
        <div className="box-container">
          ...
          <div className="box">
            ...
            <h3>Intermediate</h3>
            <h3>MPC</h3>
            <p style={{ fontSize: '20px' }}>Sri chaitanyajunior clg</p>
          </div>
          <div className="box">
            <i className="fas fa-graduation-cap"></i>
            <span>2021-2025</span>
      ...
      <section className="contact" id="contact">
        ...
        <div className="row">
          <div className="content">
            ...
            <div className="info">
              <h3> <i className="fas fa-envelope"></i> manojms3109@gmail.com</h3>
              <h3> <i className="fas fa-phone"></i> 7036894178 </h3>
